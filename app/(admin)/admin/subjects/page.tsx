...
import { Plus, Search, Library, BookOpen, GraduationCap } from "lucide-react"
      ...
      <div className="space-y-6">
        ...
        <div className="relative max-w-md">
          ...
          <Input
            ...
            className="pl-10 border border-gray-300 h-10"
          />
        </div>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-xs text-slate-500 pt-2 border-t">
                      ...
                      <Link href={`/admin/subjects/${subject.id}`} className="text-blue-600 hover:text-blue-700 font-medium">
                        View Details →
                      </Link>
                    </div>
                  </div>
