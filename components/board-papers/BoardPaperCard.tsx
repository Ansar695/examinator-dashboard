...
const BoardPaperCard = memo(
  ({ board, isAdmin, onView, onEdit, onDelete }: BoardPaperCardProps) => {
    return (
...
BoardPaperCard.displayName = "BoardPaperCard";

export default BoardPaperCard;
