...
export function MissionSection({ isRegistered }: { isRegistered: any }) {
  return (
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div className="animate-fade-in">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed mb-6">
            ExamGen Pro was founded with a simple mission: to save educators
            countless hours spent on creating examination papers while ensuring
            quality and consistency.
          </p>
          <p className="text-muted-foreground text-lg leading-relaxed mb-8">
            We believe that teachers should focus on teaching, not on tedious
            administrative tasks. Our platform combines artificial intelligence
            with a comprehensive question bank to make paper generation fast,
