...
export default function RecentPapers() {
  const [papers, setPapers] = useState(recentPapersData)
  ...
  return (
    <div className="space-y-4 animate-slide-in-up" style={{ animationDelay: "400ms" }}>
      <h2 className="text-2xl font-bold text-foreground">Last Generated Papers</h2>
        ...
        {papers.map((paper, index) => (
          ...
          >
            ...
            <div className="flex items-start justify-between mb-3">
              ...
              <span className={`px-2 py-1 rounded-md text-xs font-medium border ${difficultyColors[paper.difficulty]}`}>
                {paper.difficulty}
              </span>
            </div>
            ...
            <div className="flex gap-2">
              ...
              >
                <RotateCcw size={14} className={generatingId === paper.id ? "animate-spin" : ""} />
                <span className="hidden sm:inline">
                  {generatingId === paper.id ? "Generating..." : "Generate Again"}
                </span>
              </Button>
            </div>
          </div>
